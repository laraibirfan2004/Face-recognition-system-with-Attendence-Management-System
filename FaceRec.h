...
void addFace()
{
	...
	if (!face_cascade.load("C:\\Users\\Lenovo\\vcpkg\\buildtrees\\opencv4\\src\\4.7.0-87379d1df6.clean\\data\\haarcascades\\haarcascade_frontalface_alt.xml"))
	{
		cout << "error" << endl;
		return;
	};
...
void eigenFaceTrainer() {
	...
	model->save("D:\\LOL\\face\\eigenface.yml");
...
void  FaceRecognition() {
	...
	model->read("D:\\LOL\\face\\eigenface.yml");

	Mat testSample = imread("D:\\LOL\\face\\0.jpg", 0);
